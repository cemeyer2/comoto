...
/**
 * Handle an error loading, allow user to click 'OK' to exit loading dialog
 */
...
/**
 * Handle an error loading, force page reload on 'OK' click
 */
function reportFatalLoadingError(errorData) {
    reportLoadingError(errorData);
    $("#loadingErrorBox").html($("#loadingErrorBox").text() +
        '<br/><br/>Click "OK" to reload the page');
