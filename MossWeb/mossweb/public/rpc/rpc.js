 ...
 * Modified by Charlie Meyer <cemeyer2@illinois.edu> for use with CoMoTo
 * Copyright 2010
 *
...
//					throw Error("XML-RPC Parse Error: The provided value does not match ISO8601.");
					//modified by cemeyer2 on 12/10/10 for comoto use
					return typeEL.firstChild.nodeValue
				case 'base64':
...
rpc.ServiceProxy.prototype.__getXMLRPCResponse = function(xhr, id){
	var response = {};
	//modified by cemeyer2 on 12/10/10 for use in comoto
