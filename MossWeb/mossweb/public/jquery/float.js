//from http://www.amirharel.com/2009/08/05/implementing-floating-div
//modified november 2010 by charlie meyer for use in comoto
(function($){
/*----------------------------------------------------------------------------------
Class: FloatObject
-------------------------------------------------------------------------------------*/
	...
	{
		this.origX = this.xFunc();
		this.origY =this.yFunc();
